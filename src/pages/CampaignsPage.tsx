...
export default function CampaignsPage() {
  ...
  return (
    <div className="p-4 lg:p-6 space-y-6">
            ...
            {step === 1 && (
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea value={customMessage} onChange={(e) => e.target.value.length <= 1024 && setCustomMessage(e.target.value)} placeholder="Write your message..." className="mt-1 w-full rounded-md border border-border px-3 py-2 text-sm outline-none" rows={4} />
                </div>
                {getMessage() && (
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex items-center gap-2 rounded-md bg-muted px-3 py-2 mb-2">
                    ...
                    <input value={leadSearch} onChange={(e) => setLeadSearch(e.target.value)} placeholder="Search leads..." className="w-full bg-transparent text-sm outline-none placeholder:text-muted-foreground" />
                  </div>
      ...
      {showDetail && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-foreground/40 backdrop-blur-sm p-4" onClick={() => setShowDetail(null)}>
